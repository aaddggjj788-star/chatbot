    ...
    try {
      ...
      if (
        ...
        generationInstruction = [
          '必要な工程が1つだけ不足しているケースです。',
          '',
          '今回は不足していた1工程について、鑑定士側で補完したものとして扱います。',
          'ユーザーへ不足している言葉や工程をもう一度送るよう要求してはいけません。',
          '不足していた具体的な返信ワードを新たに指定してはいけません。',
          '',
          'まず、今回はこちらで不足分を補ったため、このまま先へ進められることを自然に伝えてください。',
          'そのうえで、今後は鑑定士から伝えた工程や送り返す言葉を、一つ一つ確認しながら丁寧に行ってほしいことを短く伝えてください。',
          '',
          'この返信の後に本来の次の鑑定文章が続きます。',
          'そのため新しい質問、新しい工程、新しい返信要求を作ってはいけません。',
          '短い補足文として作成してください。'
        ].join('\n');
